...
#for 2006
model2a=glm(treat~a2034+a3544+a4554+male+white+black+hisp+mr01+mr02+mr03+mr04+mr05+mr06+pov06
...
xBalance(treat~a2034+a3544+a4554+a5564+black+otherrace+white+male+hisp+mr05+mr06+mr01+mr02+
           mr03+mr04+pov06+inc06+emp06+ins06, element.weights=pops, data=men.study,report=c('all'))
...
arf12 = arf12[,-c(8,11,15)]
deathdata6 = merge(model2data,arf12, by=c('state','county'))
...
xBalance(treat~a2034+a3544+a4554+a5564+black+otherrace+white+male+hisp+mr05+mr06+mr01+mr02+mr03+mr04+pov06+medinc06+unemp06+ins06+strata(fm2),data=model2data,report=c('z','chisquare.test'))
xBalance(treat~a2034+a3544+a4554+a5564+black+otherrace+white+male+hisp+mr05+mr06+mr01+mr02+mr03+mr04+pov06+medinc06+unemp06+ins06+strata(fm2),data=model2data,report=c('z','chisquare.test'),element.weights=pops)


model6 = lm(mr06~a2034+a3544+a4554+black+otherrace+female+hisp+mr01+mr02+mr03+mr04+mr05+treat+pov00+pov01+pov02+pov03+pov04+pov05+emp00+emp01+emp02+emp03+emp04+emp05+inc00+inc01+inc02+inc03+inc04+inc05+ins05,data=deathdata6)
summary(model6)
```
