...
rbind(popscheck[which(is.na(popscheck$'2001')),],popscheck[which(is.na(popscheck$'2002')),],popscheck[which(is.na(popscheck$'2003')),],popscheck[which(is.na(popscheck$'2004')),],popscheck[which(is.na(popscheck$'2005')),],popscheck[which(is.na(popscheck$'2006')),])
...
#need to remove the duplicate arf variables with arfa
arfa = subset(arfall, select = -c('emp06', 'inc06', 'pov06', 'inc10', 'pov10', 'ins10', 'ins06', 'emp10'))
