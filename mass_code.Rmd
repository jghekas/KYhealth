...
That doesn't look so good -- but maybe it should be taken with a grain
of salt. The following suggests something funny about the chi-square
statistic:
```{r}
xBalance(treat~mr04+mr05,element.weights=pop06,data=mass.study,report='all')
```
