...
This file provides the matching schemes and their balance assessments.  The first chunk calculates and configures the data into the appropriate format.  The second chunk provides the matching schemes that were considered with different adjustments.  The adjustments examined are: 4 models (brglm vs glm, population weighted vs unweighted), 3 matching/control group schemes (top quartile propensity score, full matching with 1/4 of the potential control group retained, and pair matching), and 2 balance assessments (population weighted vs unweighted), for a total of 24 different balance assessments within this document. 
...
model4a=glm(treat~a2034+a3544+a4554+male+white+black+hisp+mr05+mr06+mr07+mr08+mr09+mr10+
              pov10+medinc10+unemp10+ins10,data=model4data,family=binomial(link='logit'),weights=pops)
model4b=brglm(treat~a2034+a3544+a4554+male+white+black+hisp+mr05+mr06+mr07+mr08+mr09+mr10+
                pov10+medinc10+unemp10+ins10,data=model4data,family=binomial(link='logit'))
model4c=brglm(treat~a2034+a3544+a4554+male+white+black+hisp+mr05+mr06+mr07+mr08+mr09+mr10+
                pov10+medinc10+unemp10+ins10,data=model4data,family=binomial(link='logit'),weights=pops)
fit=fitted(model4)
fita=fitted(model4a)
fitb=fitted(model4b)
