...
model4=glm(treat~a2034+a3544+a4554+male+white+black+hisp+mr05+mr06+mr07+mr08+mr09+mr10+pov10+medinc10+unemp10+ins10,data=model4data,family=binomial(link='logit'),weights=pops)
boxplot(model4)
```
...
xBalance(treat~a2034+a3544+a4554+a5564+black+otherrace+white+male+hisp+mr05+mr06+mr07+mr08+mr09+mr10+pov10+medinc10+unemp10+ins10+strata(fm23),data=model4data,report=c('adj.mean.diffs','std','z','chisquare.test'))
